...
def main():
    ...
    # Create a MIPS code generator and visit the parse tree
    mips_generator = MipsGenerator(input_file, semantic_analyzer.symbol_table, logging=True)
    mips_generator.visit(parse_tree)
    mips_generator.generate_file()
